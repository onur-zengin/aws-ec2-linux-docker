    ...
    content      = <<-EOF
      ...
      write_files:
        ...
        - path: /etc/docker/prometheus/prometheus.yml
          ...
          owner: root:root
          permissions: '0644'
        - path: /etc/docker/prometheus/alertrules.yml
          encoding: b64
      ...
      # runcmd runs only during first boot, after bootcmd.
        ...
        - [ apt-get, install, "docker.io=24.0.5-0ubuntu1~22.*", -y ]
        #- [ systemctl, start, docker ]
        #- [ systemctl, enable, docker ]
        - [ echo, "## Installing Docker Compose plugin" ]
        - [ mkdir, -p, /usr/local/lib/docker/cli-plugins/ ]
        - [ curl, -SL, "https://github.com/docker/compose/releases/download/v2.24.4/docker-compose-linux-x86_64", -o, /usr/local/lib/docker/cli-plugins/docker-compose ]
        ...
        - [ cd, /etc/docker/ ]
        - [ su, docker, -c, "docker compose up --quiet-pull -d" ]
